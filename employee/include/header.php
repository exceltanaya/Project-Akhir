                   ...
                   <br> <br>       
                    ...
                    <li>
                        <a href="./leave-status.php" >
                            <i class="fa fa-tasks menu-icon"></i><span class="nav-text">Status Cuti</span>
                        </a>
                    </li>

                    <li>
                        <a href="./apply-leave.php" >
                            <i class="fa fa-paper-plane menu-icon"></i><span class="nav-text">Mengajukan Cuti</span>
                        </a>
                    </li>

                    <li>
                        <a href="./view-employee.php" >
                            <i class="fa fa-list-ul menu-icon"></i><span class="nav-text">Melihat Semua Karyawan</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="./profile.php"  >
                            ...
                            <i class="fa fa-user menu-icon"></i><span class="nav-text">Profil</span>
                        </a>
                    </li>                 
                </ul>
            </div>
