...
<?php 
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(empty($_REQUEST["confirm_pass"])){
            $confirm_passErr = " <p style='color:red'>* Tolong Konfirmasi sandi! </p>";
        }else{
                ...
                if( $new_pass === $confirm_pass ){
                    ...
                    if (mysqli_query($conn , $change_pass_query) ){
                        ...
                        $(document).ready(function() {
                            $('#addMsg').text( 'Sandi Berhasil Diperbarui! Masuk Dengan Sandi Baru');
                    ...
                    $confirm_passErr = "<p style='color:red'>* Konfirmasi Tidak Sama Dengan Sandi Baru! </p>";
                }
