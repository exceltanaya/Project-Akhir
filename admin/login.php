              ...
              <div class="card login-form mb-0">
                <div class="card-body pt-5 shadow">
                  ...
                  <form method="POST" action=" <?php htmlspecialchars($_SERVER['PHP_SELF']) ?>">
                    ...
                    <div class="form-group">
                      <input type="submit" value="MASUK" class="btn btn-primary btn-lg w-100 " name="signin">
                    </div>
                    <p class=" login-form__footer">Bukan Admin? <a href="../employee/login.php" class="text-primary">MASUK </a>sebagai Karyawan</p>
                  </form>
                </div>
              </div>
            </div>
